declare module 'ember-table/components/ember-table' {
    import Component from '@ember/component';

    import EmberTableLoadingMore from 'ember-table/components/ember-table-loading-more';
    import EmberTableBody from 'ember-table/components/ember-tbody';
    import EmberTableFooter from 'ember-table/components/ember-tfoot';
    import EmberTableHeader from 'ember-table/components/ember-thead';

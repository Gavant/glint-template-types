declare module 'ember-truth-helpers/helpers/and' {
    ...
    import { Falsy, UnsetValue } from '@gavant/glint-template-types/types/ember-truth-helpers/-private/shared';
    ...
    export default class AndHelper<A, B = UnsetValue, C = UnsetValue, D = UnsetValue, E = UnsetValue> extends Helper<
        AndHelperSignature<A, B, C, D, E>
    > {}
}
